...
namespace SistemaRH.Controllers
{
    ...
    public class FuncionarioSalarioController : Controller
    {
        ...
        {
            var funcionarioSalarios = funcionarioSalarioTb.GetFuncionarioSalarios(vigenteEm: DateOnly.FromDateTime(DateTime.Now));
            return Ok(funcionarioSalarios);
        ...
        [HttpPost]
        public async Task<IActionResult> Create(FuncionarioSalario funcionarioSalario)
        {
        ...
        [HttpPut("{id}")]
        public async Task<IActionResult> Put(FuncionarioSalario funcionarioSalario)
        {
            string erro = ValidaFuncionarioSalario(funcionarioSalario);
        ...
        public async Task<IActionResult> Delete(int id)
        {
            ...
            if (funcionarioSalario == null)
            {
                return BadRequest("Salário não encontrado");
            }

            bool temPagamento = pagamentoTb.FuncionarioTemPagamentoComEsteSalario(funcionarioSalario.Id);

            if (temPagamento)
            {
                return BadRequest("Não é possível excluir um funcionário que possúi pagamentos realizados");
            }
